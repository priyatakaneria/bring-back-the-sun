...
#Remove enough non-confident 1's to balance the data
...
rf_classifier = RandomForestClassifier(n_estimators=430,min_samples_split=18, min_samples_leaf=4, max_features='auto', max_depth=610,random_state=1)
